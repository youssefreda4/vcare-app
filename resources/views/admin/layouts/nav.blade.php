          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                  ...
                  @forelse (auth()->guard('admin')->user()->unreadNotifications as $notification)
                      <a href="{{ route('admin.notifications', $notification->id) }}" class="dropdown-item">
                          ...
                          @elseif (isset($notification->data['status']) && isset($notification->data['patient_name']))
                              <div class="mb-3">
                                  <i class="fas fa-file mr-2"></i> {{ $notification->data['status'] }}:
